    ...
    function mapSemantic(moddle, apiData) {
        ...
        objects.forEach((object) => {
            ...
            if (object.attributeValue) {
                ...
                mapped_object.attributeValues =
                    mapped_object.attributeValues.substring(
                        0,
        ...
        const primitiveRootValus =
            apiData.rootElement.get('primitiveRootValue');
        ...
        moddle
            ...
            .then(async (apiData) => {
                ...
                lastBoard.get('boardElements').forEach((boardElement) => {
                    ...
                    if (
                        !allBoardElements.some(
                            (element) => element.id === boardElement.id,
                        )
                    ) {
