...
/**
 * Parse and render an object diagram.
 *
 ...
 * @param {ModdleElement<OdRootBoard>|String} [rootBoard] Od board or id of board to render (if not provided, the first one will be rendered)
 *
...
/**
 * Import parsed definitions and render an od diagram.
 *
 * Once finished the viewer reports back the result to the
 * provided callback function with (err, warnings).
 *
 ...
 * You can use these events to hook into the life-cycle.
 *
 * @param {ModdleElement<Definitions>} definitions parsed od definitions
 * @param {ModdleElement<OdRootBoard>|String} [rootBoard] Od board or id of board to render (if not provided, the first one will be rendered)
 *
...
function checkValidationError(err) {
  ...
  // check if we can help the user by indicating wrong OD xml
 ...
 *
 * @return {ModdleElement<ODRootBoard>|null}
 */
